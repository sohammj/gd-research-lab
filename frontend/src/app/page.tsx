...
// //   // inside Page() component, after your useState() hooks:

// //   // ---- MIC RECORDER -> STT glue ----
// //   const recorder = useMicRecorder(async (blob) => {
// //     try {
// //       // Turn mic blob into a File (AssemblyAI is fine with webm/opus, wav, m4a, mp3)
// //       const file = new File([blob], `speech-${Date.now()}.webm`, { type: blob.type || "audio/webm" });

// //       pushToast("Uploading audio…");
// //       const uploadUrl = await sttUpload(file);

// //       pushToast("Starting transcription…");
// //       const tid = await sttStart(uploadUrl);

// //       const text = await sttPoll(tid);
// //       setIdea((prev) => (prev ? prev + "\n\n" + text : text));
// //       pushToast("Transcription complete");
// //     } catch (e: any) {
// //       pushToast(e?.message || "Transcription failed");
// //     }
// //   });
